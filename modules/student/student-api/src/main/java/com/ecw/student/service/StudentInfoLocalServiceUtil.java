 ...
 * {@link com.ecw.student.service.impl.StudentInfoLocalServiceImpl} and is the
 ...
 * @see com.ecw.student.service.base.StudentInfoLocalServiceBaseImpl
 * @see com.ecw.student.service.impl.StudentInfoLocalServiceImpl
 * @generated
 */
@ProviderType
public class StudentInfoLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link com.ecw.student.service.impl.StudentInfoLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static com.ecw.student.model.StudentInfo addStudentInfo(
		com.ecw.student.model.StudentInfo studentInfo) {
	...
	*/
	public static com.ecw.student.model.StudentInfo createStudentInfo(long Id) {
		return getService().createStudentInfo(Id);
	}
	...
	*/
	public static com.ecw.student.model.StudentInfo deleteStudentInfo(long Id)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService().deleteStudentInfo(Id);
	}
	...
	* @return the student info that was removed
	*/
	public static com.ecw.student.model.StudentInfo deleteStudentInfo(
		com.ecw.student.model.StudentInfo studentInfo) {
	...
	*/
	...
	public static com.ecw.student.model.StudentInfo fetchStudentInfo(long Id) {
		return getService().fetchStudentInfo(Id);
	}
	...
	* @throws PortalException if a student info with the primary key could not be found
	*/
	public static com.ecw.student.model.StudentInfo getStudentInfo(long Id)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService().getStudentInfo(Id);
	}
	...
	*/
	public static java.util.List<com.ecw.student.model.StudentInfo> getStudentInfos(
		int start, int end) {
	...
	*/
	public static com.ecw.student.model.StudentInfo updateStudentInfo(
		com.ecw.student.model.StudentInfo studentInfo) {
	...
	private static ServiceTracker<StudentInfoLocalService, StudentInfoLocalService> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(StudentInfoLocalService.class);

		ServiceTracker<StudentInfoLocalService, StudentInfoLocalService> serviceTracker =
			new ServiceTracker<StudentInfoLocalService, StudentInfoLocalService>(bundle.getBundleContext(),
