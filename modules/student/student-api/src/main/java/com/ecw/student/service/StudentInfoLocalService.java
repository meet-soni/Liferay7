...
/**
 * Provides the local service interface for StudentInfo. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see StudentInfoLocalServiceUtil
...
public interface StudentInfoLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link StudentInfoLocalServiceUtil} to access the student info local service. Add custom service methods to {@link com.ecw.student.service.impl.StudentInfoLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public StudentInfo createStudentInfo(long Id);
	...
	*/
	...
	public StudentInfo deleteStudentInfo(long Id) throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public StudentInfo deleteStudentInfo(StudentInfo studentInfo);
	...
	*/
	...
	public StudentInfo fetchStudentInfo(long Id);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public StudentInfo getStudentInfo(long Id) throws PortalException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<StudentInfo> getStudentInfos(int start, int end);
